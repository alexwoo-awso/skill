...
See the main file [SKILL.md](https://github.com/alexwoo-awso/skill/blob/main/ksef-accountant-en/SKILL.md) for competency overview.
...
### Changelog
- **v2.1.3** - Changed all relative markdown links to absolute (GitHub) for clawhub.ai compatibility
